...
class SentimentController(QtCore.QObject):
    ...
    def __init__(self, sentiment_widget, parent=None):
        ...
        #self._classifier = SentimentIntensityAnalyzer() sentences=["hello","why is it not working?!"]
        self._classifier = SIA()
    ...
    def analyze_tweets(self, coordinates: list, tweets: list):
        ...
        for country, tweet in zip(country_codes, tweets):
            sentiment = self._classifier.polarity_scores('compound')
        """
        ...
        for country, tweet in zip(country_codes, tweets):
            ...
            composant = ('compound')
            sentiment = self._classifier.polarity_scores(composant)
            try:
...
class MapWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        #self.map_(MY_LAT_HERE, MY_LONG_HERE)
